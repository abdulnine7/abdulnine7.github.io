// ============================================================
// SETTINGS WINDOW – Rendering & Window Management
...
function renderExperience() {
  ...
  html += '<div class="settings-section-subtitle">' + PROFILE.experience.length + ' positions</div>';
...
function renderContact() {
  ...
  // GitHub
  html += '<a class="settings-contact-link" href="' + h(PROFILE.contact.github) + '" target="_blank">';
  ...
  html += '<span class="settings-contact-value">' + h(PROFILE.contact.github.replace('https://github.com/','')) + '</span>';
  html += '</a>';

  // LinkedIn
  html += '<a class="settings-contact-link" href="' + h(PROFILE.contact.linkedin) + '" target="_blank">';
  ...
  html += '<span class="settings-contact-value">' + h(PROFILE.contact.linkedin.replace('https://www.linkedin.com/in/','')) + '</span>';
  html += '</a>';

  // Instagram
  html += '<a class="settings-contact-link" href="' + h(PROFILE.contact.instagram) + '" target="_blank">';
  ...
  html += '<span class="settings-contact-value">@' + h(PROFILE.contact.instagramHandle) + '</span>';
  html += '</a>';

  // Email
  html += '<a class="settings-contact-link" href="mailto:' + h(PROFILE.contact.email) + '">';
  ...
  html += '<span class="settings-contact-value">' + h(PROFILE.contact.email) + '</span>';
  html += '</a>';

  // Source Code
  html += '<a class="settings-contact-link" href="' + h(PROFILE.contact.repo) + '" target="_blank">';
